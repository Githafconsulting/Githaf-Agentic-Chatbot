        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20">
            {mainFeatures.map((feature, index) => (
              ...
              >
                <Card hover variant="elevated" glass className="h-full p-6">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {advancedFeatures.map((feature, index) => (
                ...
                >
                  <Card glass variant="elevated" className="p-8 h-full">
          ...
          >
            <Card glass variant="elevated" className="p-12 max-w-3xl mx-auto bg-gradient-to-br from-primary-500/10 to-accent-500/10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/signup"
                  className="inline-flex items-center justify-center px-8 py-4 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-medium transition-all shadow-lg hover:shadow-xl"
                >
                  Start Free Trial
                ...
                <a
                  href="/pricing"
                  className="inline-flex items-center justify-center px-8 py-4 glass border-2 border-primary-600 text-primary-600 dark:text-primary-400 rounded-xl font-medium transition-all hover:bg-primary-50 dark:hover:bg-primary-900/20"
                >
                  View Pricing
                </a>
              </div>
